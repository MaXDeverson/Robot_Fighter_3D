...
public class EnemyActions : MonoBehaviour
{
    ...
    public bool IsGrounded()
    {
        ...
        if (Physics.CheckCapsule(capsule.bounds.center, capsule.bounds.center + (Vector3.down * 1.2f * colliderSize), capsule.radius, CollisionLayer))
        {
            isGrounded = true;
            return true;
        }
